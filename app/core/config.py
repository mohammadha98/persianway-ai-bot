...
class Settings(BaseSettings):
    ...
    # Deprecated settings (for backward compatibility with .env files)
    OPENAI_MODEL_NAME: Optional[str] = None
    OPENAI_TEMPERATURE: Optional[str] = None
    OPENAI_MAX_TOKENS: Optional[str] = None
    # Project info
    ...
    PREFERRED_API_PROVIDER: str = "openrouter"  # Options: "auto", "openai", "openrouter"
    ...
    YOUR_SITE_URL: str = "http://localhost:3000"
    YOUR_SITE_NAME: str = "PersianWay AI Bot"
