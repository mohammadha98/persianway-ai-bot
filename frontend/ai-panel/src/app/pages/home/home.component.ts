...
export class HomeComponent {
  features = [
    {
      title: 'گفتگوی هوشمند',
      description: 'با دستیار هوش مصنوعی ما تعامل کنید و پاسخ‌های دقیق درباره کشاورزی فارسی دریافت کنید',
      icon: 'chat',
      route: '/chat',
    ...
    {
      title: 'مشارکت داده',
      description: 'دانش خود را به پایگاه داده ما اضافه کنید تا به بهبود پایگاه دانش کشاورزی ما کمک کنید',
      icon: 'add_circle',
      route: '/contribute',
